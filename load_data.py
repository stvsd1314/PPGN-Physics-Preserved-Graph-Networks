...
def load_data_single_observ( name_train, name_test, num_labelper ,seed, measured_index,    phase =  'pp',  device = 'cpu', random = False ,  root = "./data/"):
    assert phase in ['sp1' , 'sp3' , 'sp13' , 'ppg' , 'pp' ,'ground','ind_single'  ]
    ...
    ind_labels =  randomize_labels(seed, labels[ind_train]  , int(num_labelper) ) 
...
class dataCenter(object):
        def __init__(self,  name_train, name_test,    num_labelper,seed, measured_index, phase= 'ppg', dataSet = 'loc', root = "./data/"):
